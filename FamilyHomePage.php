	...
	<body>
		...
		<div class="float-middle-posts">
			...
			<?php
				...
				$query_string = "SELECT * FROM post WHERE homepage_id > 1";
				...
				while ($post = $home_posts->fetch_assoc()) {
					...
					if (isset($_POST['create'])) {
						...
						$new_link = "FamilyHomePage.php?username=".$_SESSION['username'];
			...
			<?php
				...
				$homepage_id = 2;
				$create_post_link = "WritePostHome.php?username=".$_SESSION['username']."&homepage_id=".$homepage_id;
