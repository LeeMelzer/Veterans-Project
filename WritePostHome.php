		...
		<div class="important-links">
			...
			<?php
				...
				if (isset($_POST['create'])) {
					...
					// add homepage_id at the end
					$q = "INSERT INTO post (post_id, title, post_body, likes_count, username, group_id, homepage_id) VALUES (NULL, '".$title."', '".$post_body."', NULL, '".$_SESSION['username']."', NULL, '".$homepage_id."')";
					$mysqli->query($q); 
					if ($homepage_id == 1) {
						$home_link = "HomePage.php?username=".$_SESSION['username'];
						header("Location:".$home_link.""); 
						exit(); 
					}
					else {
						$home_link = "FamilyHomePage.php?username=".$_SESSION['username'];
						header("Location:".$home_link.""); 
						exit();
					}
				}
